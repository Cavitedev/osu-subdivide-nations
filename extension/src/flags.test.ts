...
describe("Test flags.json content", () => {
    ...
    describe("Test flag links", () => {
        const flagLinks = Object.values(flagsJson).flatMap((country) =>
            Object.values(country.regions).flatMap((region) => region.flag),
        );
    ...
    describe("Test native names", () => {
        const nativeNames = Object.values(flagsJson).flatMap((country) =>
            Object.values(country.regions).flatMap((region) => region.nativeName),
        );
